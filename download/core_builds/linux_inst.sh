...
curl https://gitee.com/xiaokang00010/ECodeScript/raw/master/download/core_builds/ECode.Script_Release_1.zip >> /var/tmp/autoinst.zip
echo Downloaded 1 files
read -p "Install ECode.Script To(Please Input Absolute path!): " ECode_Script_Install_Path
...
read -p "Would You Want Add ECode.Script To PATH(y/n)?" ADDTOPATH
